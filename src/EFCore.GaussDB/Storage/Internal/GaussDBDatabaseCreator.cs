...
/// </summary>
public class GaussDBDatabaseCreator(
...
""");
    ...
    private async Task<bool> Exists(bool async, CancellationToken cancellationToken = default)
    {
        ...
        var unpooledCsb = new GaussDBConnectionStringBuilder(connection.ConnectionString) { Pooling = false, Multiplexing = false };
    ...
    public override void Delete()
    {
        ...
        {
            case GaussDBDataSource dataSource:
                dataSource.Clear();
                break;
            case null:
                ClearAllPools();
    ...
    public override void CreateTables()
    {
        ...
        if (reloadTypes && connection.DbConnection is GaussDBConnection npgsqlConnection)
        {
    ...
    private IReadOnlyList<MigrationCommand> CreateDropCommands()
    {
        var operations = new MigrationOperation[]
        {
            ...
            // Issue #775
            new GaussDBDropDatabaseOperation { Name = connection.DbConnection.Database }
        };
    ...
    private void ClearPool()
        => GaussDBConnection.ClearPool((GaussDBConnection)connection.DbConnection);
}
