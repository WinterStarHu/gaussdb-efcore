...
public class GaussDBTypeMappingSource : RelationalTypeMappingSource
{
    ...
    private readonly GaussDBStringTypeMapping _jsonpath = new("jsonpath", GaussDBDbType.JsonPath);
    ...
    private readonly GaussDBRangeTypeMapping _tstzrange, _tstzrangeDto;
        ...
        : base(dependencies, relationalDependencies)
    {
        ...
        _tstzrangeDto = GaussDBRangeTypeMapping.CreatBuiltInRangeMapping(
            "tstzrange", typeof(GaussDBRange<DateTimeOffset>), GaussDBDbType.TimestampTzRange, _timestamptzDto);
        ...
        var storeTypeMappings = new Dictionary<string, RelationalTypeMapping[]>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "macaddr", [_macaddr] },
            { "macaddr8", [_macaddr8] },
            { "inet", [_inetAsIPAddress, _inetAsGaussDBInet] },
#pragma warning disable CS0612 // _cidr exposes obsolete legacy GaussDBCidr mapping
            { "cidr", [_cidr] },
...
#pragma warning disable CS0618, CS0612 // _cidr exposes obsolete legacy GaussDBCidr mapping
...
#pragma warning restore CS0618, CS0612
    ...
    protected virtual RelationalTypeMapping? FindEnumMapping(in RelationalTypeMappingInfo mappingInfo)
    {
        ...
        return new GaussDBEnumTypeMapping(
