...
""");
    ...
    {
        // GaussDB doesn't allow varchar(x) with x > 10485760, so we map this to text.
...
""");
    ...
    #endregion GaussDB collation management
    ...
    #endregion GaussDB full-text search
