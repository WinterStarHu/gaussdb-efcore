...
public class GaussDBValueGenerationScenariosTest
{
    private static readonly string DatabaseName = "GaussDBValueGenerationScenariosTest";
    ...
    public abstract class ContextBase(string databaseName) : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder
                ...
                .UseGaussDB(
                    GaussDBTestStore.CreateConnectionString(databaseName),
