    ...
    : NorthwindBulkUpdatesRelationalTestBase<NorthwindBulkUpdatesGaussDBFixture<NoopModelCustomizer>>(fixture, testOutputHelper)
{
    ...
    private const string ComplexBulkMutationSkip =
        "Local-only: current GaussDB bulk delete/update SQL generation still produces malformed DELETE/UPDATE ... SELECT forms for these complex Northwind shapes and throws Inconceivable!.";
