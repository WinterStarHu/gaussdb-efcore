...
public class JsonTypesGaussDBTest(NonSharedFixture fixture) : JsonTypesRelationalTestBase(fixture)
{
    ...
    public virtual Task Can_read_write_collection_of_DateOnly_JSON_values_npgsql()
        => Can_read_and_write_JSON_value<GaussDBDateOnlyCollectionType, List<DateOnly>>(
    ...
    protected class GaussDBDateOnlyCollectionType
    {
    ...
    public virtual Task Can_read_write_collection_of_DateTime_JSON_values_npgsql(string expected)
        => Can_read_and_write_JSON_value<GaussDBDateTimeCollectionType, List<DateTime>>(
            modelBuilder => modelBuilder
                .Entity<GaussDBDateTimeCollectionType>()
                .HasNoKey()
    ...
    protected class GaussDBDateTimeCollectionType
    {
    ...
    public virtual Task Can_read_write_LogSequenceNumber_JSON_values(ulong value, string json)
        => Can_read_and_write_JSON_value<LogSequenceNumberType, GaussDBLogSequenceNumber>(
            nameof(LogSequenceNumberType.LogSequenceNumber),
            new GaussDBLogSequenceNumber(value),
            json);
    ...
    {
        public GaussDBLogSequenceNumber LogSequenceNumber { get; set; }
    }
