        ...
        using (var context = CreateContext())
        {
            context.Set<MappedNullableDataTypes>().Add(
                new MappedNullableDataTypes
                {
                    ...
                    GaussDBPointAsPoint = new GaussDBPoint(5.2, 3.3),
                    StringAsJsonb = """{"a": "b"}""",
                    StringAsJson = """{"a": "b"}""",
                    ...
                    GaussDBRangeAsRange = new GaussDBRange<int>(4, true, 8, false),
...
#pragma warning disable CS0618 // Full-text search client-parsing is obsolete
                    SearchQuery = GaussDBTsQuery.Parse("a & b"),
                    SearchVector = GaussDBTsVector.Parse("a b"),
#pragma warning restore CS0618
        ...
        using (var context = CreateContext())
        {
            ...
            // GaussDBPoint? param29 = new GaussDBPoint(5.2, 3.3);
...
#pragma warning restore CS0618
    ...
    public virtual void Can_query_using_any_mapped_data_types_with_nulls()
    {
        ...
        using (var context = CreateContext())
        {
            ...
            //GaussDBPoint? param29 = null;
            //Assert.Same(entity, context.Set<MappedNullableDataTypes>().Single(e => e.Int == 911 && e.GaussDBPointAsPoint == param29));
...
#pragma warning disable CS0618 // Full-text search client-parsing is obsolete
        Assert.Equal(GaussDBTsQuery.Parse("a & b").ToString(), entity.SearchQuery.ToString());
        Assert.Equal(GaussDBTsVector.Parse("a b").ToString(), entity.SearchVector.ToString());
#pragma warning restore CS0618
        Assert.Equal(GaussDBTsRankingNormalization.DivideByLength, entity.RankingNormalization);
    }
...
""");
    ...
    protected class MappedDataTypes
    {
        ...
        public GaussDBPoint GaussDBPointAsPoint { get; set; }
        ...
        public GaussDBRange<int> GaussDBRangeAsRange { get; set; }
        ...
        public GaussDBTsQuery SearchQuery { get; set; }
        public GaussDBTsVector SearchVector { get; set; }
        public GaussDBTsRankingNormalization RankingNormalization { get; set; }
