...
public class CompatibilityQueryGaussDBTest : IClassFixture<CompatibilityQueryGaussDBTest.CompatibilityQueryGaussDBFixture>
{
    ...
    public CompatibilityQueryGaussDBTest(CompatibilityQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    {
        Fixture = fixture;
    ...
    public class CompatibilityQueryGaussDBFixture : FixtureBase, IDisposable, IAsyncLifetime
    {
        private TestStore _testStore = null!;

        private const string StoreName = "CompatibilityTest";
        private readonly ListLoggerFactory _listLoggerFactory = GaussDBTestStoreFactory.Instance.CreateListLoggerFactory(_ => false);
        ...
        public virtual CompatibilityContext CreateContext(Version? postgresVersion)
        {
            ...
            builder
                .UseGaussDB(o => o.SetPostgresVersion(postgresVersion))
        ...
        {
            _testStore = GaussDBTestStoreFactory.Instance.GetOrCreate(StoreName);
