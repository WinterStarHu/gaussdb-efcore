...
public class JsonQueryGaussDBTest : JsonQueryRelationalTestBase<JsonQueryGaussDBTest.JsonQueryGaussDBFixture>
{
    ...
    private const string JsonProjectionSkip =
        "Local-only: current openGauss JSON all-types projection for this shape diverges from the provider expectation; fixing it would require broader JSON projection work.";

    public JsonQueryGaussDBTest(JsonQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
    ...
    public override async Task Json_collection_index_in_projection_using_untranslatable_client_method(bool async)
    {
        ...
        Assert.Contains(
            CoreStrings.QueryUnableToTranslateMethod(
                "Microsoft.EntityFrameworkCore.Query.JsonQueryTestBase<Microsoft.EntityFrameworkCore.Query.JsonQueryGaussDBTest+JsonQueryGaussDBFixture>",
                "MyMethod"),
            message);
    }
...
""");
    ...
    [ConditionalTheory(Skip = WithOrdinalitySkip)]
...
""");
    ...
    [ConditionalTheory(Skip = JsonProjectionSkip)]
    [InlineData(false)]
    [InlineData(true)]
...
""");
    ...
    public class JsonQueryGaussDBFixture : JsonQueryRelationalFixture, IQueryFixtureBase
    {
        ...
        public JsonQueryGaussDBFixture()
        {
