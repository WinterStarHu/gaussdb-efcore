    ...
    ComplexTypeQueryGaussDBTest.ComplexTypeQueryGaussDBFixture>
{
    ...
    private const string ComplexTypeSkip =
        "openGauss complex-type SQL shape and baseline output diverge from provider expectations for these projections and set operations.";
    ...
    [ConditionalTheory(Skip = ComplexTypeSkip)]
...
""");
    ...
    [ConditionalFact(Skip = ComplexTypeSkip)]
