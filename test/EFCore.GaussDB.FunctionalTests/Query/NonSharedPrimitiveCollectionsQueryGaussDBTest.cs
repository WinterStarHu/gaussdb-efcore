    ...
    : NonSharedPrimitiveCollectionsQueryRelationalTestBase(fixture)
{
    ...
    // GaussDB maps DateTime to timestamp with time zone by default, which requires UTC timestamps.
    ...
    // GaussDB only supports DateTimeOffset with Offset 0 (mapped to timestamp with time zone)
