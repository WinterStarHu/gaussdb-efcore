...
public class PrimitiveCollectionsQueryGaussDBTest : PrimitiveCollectionsQueryRelationalTestBase<
    PrimitiveCollectionsQueryGaussDBTest.PrimitiveCollectionsQueryGaussDBFixture>
{
    public PrimitiveCollectionsQueryGaussDBTest(PrimitiveCollectionsQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
...
""");
    ...
    {
        var ranges = new GaussDBRange<int>[]
        {
            new(5, 15),
            new(40, 50)
        };

        await AssertQuery(ss => ss.Set<PrimitiveCollectionsEntity>().Where(e => ranges.Contains(e.Int)),
...
""");
    ...
    public virtual async Task Parameter_collection_Concat_Column_collection_Concat_parameter()
    {
        ...
        await AssertQuery(ss => ss.Set<PrimitiveCollectionsEntity>().Where(c => ints1.Concat(c.Ints).Concat(ints2).Count() == 4));
...
""");
    ...
    public override async Task Column_collection_equality_inline_collection_with_parameters()
    {
        ...
        await AssertQuery(ss => ss.Set<PrimitiveCollectionsEntity>().Where(c => c.Ints == new[] { i, j }),
...
""");
    ...
    public override async Task Project_multiple_collections()
    {
        ...
        await AssertQuery(ss => ss.Set<PrimitiveCollectionsEntity>().OrderBy(x => x.Id).Select(
                x => new
                {
                    Ints = x.Ints.ToList(),
...
""");
    ...
    {
        await AssertQuery(// ReSharper disable once ReplaceWithSingleCallToCount
...
""");
    ...
    public class PrimitiveCollectionsQueryGaussDBFixture : PrimitiveCollectionsQueryFixtureBase, ITestSqlLoggerFactory
    {
