...
public class TPTGearsOfWarQueryGaussDBTest : TPTGearsOfWarQueryRelationalTestBase<TPTGearsOfWarQueryGaussDBFixture>
{
    ...
    public TPTGearsOfWarQueryGaussDBTest(TPTGearsOfWarQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
