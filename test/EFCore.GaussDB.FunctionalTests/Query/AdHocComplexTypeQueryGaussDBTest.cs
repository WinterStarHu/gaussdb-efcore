...
public class AdHocComplexTypeQueryGaussDBTest(NonSharedFixture fixture) : AdHocComplexTypeQueryTestBase(fixture)
{
    // Test is SQL Server-specific and being removed upstream.
