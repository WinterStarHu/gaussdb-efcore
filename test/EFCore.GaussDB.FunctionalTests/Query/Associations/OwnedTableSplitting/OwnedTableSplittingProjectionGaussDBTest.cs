...
public class OwnedTableSplittingProjectionGaussDBTest(OwnedTableSplittingGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingProjectionRelationalTestBase<OwnedTableSplittingGaussDBFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, r0."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "OptionalRelated_NestedCollection" AS o ON CASE
    WHEN r."OptionalAssociate_Id" IS NOT NULL AND r."OptionalAssociate_Int" IS NOT NULL AND r."OptionalAssociate_Ints" IS NOT NULL AND r."OptionalAssociate_Name" IS NOT NULL AND r."OptionalAssociate_String" IS NOT NULL THEN r."Id"
END = o."AssociateTypeRootEntityId"
ORDER BY r."Id" NULLS FIRST, o."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "RelatedCollection_NestedCollection" AS r1 ON r0."RootEntityId" = r1."AssociateTypeRootEntityId" AND r0."Id" = r1."AssociateTypeId"
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r0."Id" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST, r1."AssociateTypeId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."AssociateTypeRootEntityId" NULLS FIRST, s."AssociateTypeId" NULLS FIRST, s."Id0" NULLS FIRST, o."AssociateTypeRootEntityId" NULLS FIRST, o."Id" NULLS FIRST, r2."AssociateTypeRootEntityId" NULLS FIRST, r2."Id" NULLS FIRST, s0."RootEntityId" NULLS FIRST, s0."Id" NULLS FIRST, s0."AssociateTypeRootEntityId" NULLS FIRST, s0."AssociateTypeId" NULLS FIRST, s0."Id0" NULLS FIRST, o0."AssociateTypeRootEntityId" NULLS FIRST, o0."Id" NULLS FIRST, r5."AssociateTypeRootEntityId" NULLS FIRST
""");
    }
