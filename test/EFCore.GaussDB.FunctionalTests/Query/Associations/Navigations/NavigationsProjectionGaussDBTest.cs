...
public class NavigationsProjectionGaussDBTest(NavigationsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsProjectionRelationalTestBase<NavigationsGaussDBFixture>(fixture, testOutputHelper)
{
