...
public class NavigationsIncludeGaussDBTest(NavigationsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsIncludeRelationalTestBase<NavigationsGaussDBFixture>(fixture, testOutputHelper)
{
