...
public class ComplexTableSplittingProjectionGaussDBTest(
    ComplexTableSplittingGaussDBFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingProjectionRelationalTestBase<ComplexTableSplittingGaussDBFixture>(fixture, testOutputHelper)
{
