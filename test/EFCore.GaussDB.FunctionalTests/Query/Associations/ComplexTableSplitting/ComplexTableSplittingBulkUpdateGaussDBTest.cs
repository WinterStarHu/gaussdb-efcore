...
public class ComplexTableSplittingBulkUpdateGaussDBTest(
    ComplexTableSplittingGaussDBFixture fixture,
...
""");
    ...
    public override async Task Update_property_inside_associate_with_special_chars()
    {
        ...
        AssertExecuteUpdateSql(
            """
UPDATE "RootEntity" AS r
SET "RequiredAssociate_String" = '{ Some other/JSON:like text though it [isn''t]: 诪诪砖 诪诪砖 诇讗茅猫茅猫 }'
WHERE r."RequiredAssociate_String" = '{ this may/look:like JSON but it [isn''t]: 诪诪砖 诪诪砖 诇讗茅猫茅猫 }'
""");
    }
