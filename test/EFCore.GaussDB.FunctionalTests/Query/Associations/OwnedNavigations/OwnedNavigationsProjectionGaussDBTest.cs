...
public class OwnedNavigationsProjectionGaussDBTest(OwnedNavigationsGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedNavigationsProjectionRelationalTestBase<OwnedNavigationsGaussDBFixture>(fixture, testOutputHelper)
{
...
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."AssociateTypeRootEntityId" NULLS FIRST, o1."AssociateTypeRootEntityId" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST, r2."AssociateTypeRootEntityId" NULLS FIRST, s."RootEntityId" NULLS FIRST, s."Id" NULLS FIRST, s."AssociateTypeRootEntityId" NULLS FIRST, s."AssociateTypeId" NULLS FIRST, s."AssociateTypeRootEntityId0" NULLS FIRST, s."AssociateTypeId0" NULLS FIRST, s."AssociateTypeRootEntityId1" NULLS FIRST, s."AssociateTypeId1" NULLS FIRST, s."Id0" NULLS FIRST, o2."AssociateTypeRootEntityId" NULLS FIRST, o2."Id" NULLS FIRST, r7."AssociateTypeRootEntityId" NULLS FIRST
""");
    }
...
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST, r2."AssociateTypeRootEntityId" NULLS FIRST, r3."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "OptionalRelated_RequiredNested" AS o1 ON o."RootEntityId" = o1."AssociateTypeRootEntityId"
LEFT JOIN "OptionalRelated_NestedCollection" AS o2 ON o."RootEntityId" = o2."AssociateTypeRootEntityId"
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."AssociateTypeRootEntityId" NULLS FIRST, o1."AssociateTypeRootEntityId" NULLS FIRST, o2."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
ORDER BY r."Id" NULLS FIRST, o."RootEntityId" NULLS FIRST, o0."AssociateTypeRootEntityId" NULLS FIRST
""");
        }
    }
...
LEFT JOIN "RelatedCollection_RequiredNested" AS r2 ON r0."RootEntityId" = r2."AssociateTypeRootEntityId" AND r0."Id" = r2."AssociateTypeId"
LEFT JOIN "RelatedCollection_NestedCollection" AS r3 ON r0."RootEntityId" = r3."AssociateTypeRootEntityId" AND r0."Id" = r3."AssociateTypeId"
ORDER BY r."Id" NULLS FIRST, r0."RootEntityId" NULLS FIRST, r0."Id" NULLS FIRST, r1."AssociateTypeRootEntityId" NULLS FIRST, r1."AssociateTypeId" NULLS FIRST, r2."AssociateTypeRootEntityId" NULLS FIRST, r2."AssociateTypeId" NULLS FIRST, r3."AssociateTypeRootEntityId" NULLS FIRST, r3."AssociateTypeId" NULLS FIRST
""");
        }
    }
...
FROM "RootEntity" AS r
LEFT JOIN LATERAL (
    SELECT r2."AssociateTypeRootEntityId", r2."Id", r2."Int", r2."Ints", r2."Name", r2."String"
