...
public class OwnedJsonProjectionGaussDBTest(OwnedJsonGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedJsonProjectionRelationalTestBase<OwnedJsonGaussDBFixture>(fixture, testOutputHelper)
{
