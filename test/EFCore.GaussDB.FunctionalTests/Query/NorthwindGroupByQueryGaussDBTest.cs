...
public class NorthwindGroupByQueryGaussDBTest : NorthwindGroupByQueryRelationalTestBase<NorthwindQueryGaussDBFixture<NoopModelCustomizer>>
{
    ...
    private const string FilteredAggregateSkip =
        "Local-only: current openGauss target rejects aggregate FILTER (...) syntax emitted for these GroupBy aggregate shapes; fixing it cleanly would require broader SQL-generation changes.";

    // ReSharper disable once UnusedParameter.Local
    public NorthwindGroupByQueryGaussDBTest(
...
""");
    ...
    [ConditionalTheory(Skip = FilteredAggregateSkip)]
...
""");
    ...
    [ConditionalTheory(Skip = "Local-only: current GaussDB version doesn't support LATERAL subqueries/APPLY patterns generated by the provider. Upstream note: https://github.com/dotnet/efcore/pull/28410")]
