...
public class NetworkTranslationsGaussDBTest : IClassFixture<NetworkTranslationsGaussDBTest.NetworkAddressQueryGaussDBFixture>
{
    ...
    public NetworkTranslationsGaussDBTest(NetworkAddressQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    {
        Fixture = fixture;
    ...
    public void Demonstrate_ValueTypeParametersAreDuplicated()
    {
        ...
        var cidr = new GaussDBCidr(IPAddress.Any, default);
...
""");
    ...
    /// </summary>
    public class NetworkAddressQueryGaussDBFixture : SharedStoreFixtureBase<NetContext>
    {
            ...
            for (var i = 1; i <= 9; i++)
            {
                ...
                context.NetTestEntities.Add(
                    new NetTestEntity
                    {
                        Id = i,
                        Inet = ip,
                        Cidr = new GaussDBCidr(IPAddress.Parse("192.168.1.0"), 24),
                        Macaddr = macaddr,
                        Macaddr8 = macaddr8,
