...
public class GearsOfWarQueryGaussDBTest : GearsOfWarQueryRelationalTestBase<GearsOfWarQueryGaussDBFixture>
{
    private const string QueryShapeSkip =
        "openGauss provider still has gaps for correlated-collection SQL, nullability processing, and DateOnly/TimeSpan materialization in these GearsOfWar query shapes";

    // ReSharper disable once UnusedParameter.Local
    public GearsOfWarQueryGaussDBTest(GearsOfWarQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
        : base(fixture)
    {
