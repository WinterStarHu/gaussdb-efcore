...
public class FuzzyStringMatchQueryGaussDBTest : IClassFixture<FuzzyStringMatchQueryGaussDBTest.FuzzyStringMatchQueryGaussDBFixture>
{
    ...
    public FuzzyStringMatchQueryGaussDBTest(FuzzyStringMatchQueryGaussDBFixture fixture, ITestOutputHelper testOutputHelper)
    {
        Fixture = fixture;
    ...
    /// </summary>
    public class FuzzyStringMatchQueryGaussDBFixture : SharedStoreFixtureBase<FuzzyStringMatchContext>
    {
