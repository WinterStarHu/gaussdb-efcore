...
public class GaussDBNodaTimeTypeMappingTest
{
    ...
    [Fact]
    public void GaussDBRange_of_LocalDateTime_is_properly_mapped()
    {
        Assert.Equal("tsrange", GetMapping(typeof(GaussDBRange<LocalDateTime>)).StoreType);
        Assert.Same(typeof(GaussDBRange<LocalDateTime>), GetMapping("tsrange").ClrType);
    }
    ...
    public void GenerateSqlLiteral_returns_tsrange_literal()
    {
        ...
        var value = new GaussDBRange<LocalDateTime>(new LocalDateTime(2020, 1, 1, 12, 0, 0), new LocalDateTime(2020, 1, 2, 12, 0, 0));
        Assert.Equal("""'["2020-01-01T12:00:00","2020-01-02T12:00:00"]'::tsrange""", mapping.GenerateSqlLiteral(value));
    }

    [Fact]
    public void Array_of_GaussDBRange_of_LocalDateTime_is_properly_mapped()
    {
        Assert.Equal("tsmultirange", GetMapping(typeof(GaussDBRange<LocalDateTime>[])).StoreType);
        Assert.Same(typeof(List<GaussDBRange<LocalDateTime>>), GetMapping("tsmultirange").ClrType);
    }

    [Fact]
    public void List_of_GaussDBRange_of_LocalDateTime_is_properly_mapped()
        => Assert.Equal("tsmultirange", GetMapping(typeof(List<GaussDBRange<LocalDateTime>>)).StoreType);
    ...
    public void GenerateSqlLiteral_returns_tstzrange_ZonedDateTime_literal()
    {
        ...
        var value = new GaussDBRange<ZonedDateTime>(
    ...
    public void GenerateSqlLiteral_returns_tstzrange_OffsetDateTime_literal()
    {
        ...
        var value = new GaussDBRange<OffsetDateTime>(
    ...
    [Fact]
    public void Array_of_GaussDBRange_of_Instant_is_properly_mapped()
        => Assert.Equal("tstzmultirange", GetMapping(typeof(GaussDBRange<Instant>[])).StoreType);

    [Fact]
    public void List_of_GaussDBRange_of_Instant_is_properly_mapped()
        => Assert.Equal("tstzmultirange", GetMapping(typeof(List<GaussDBRange<Instant>>)).StoreType);
    ...
    [Fact]
    public void GaussDBRange_of_LocalDate_is_properly_mapped()
        => Assert.Equal("daterange", GetMapping(typeof(GaussDBRange<LocalDate>)).StoreType);
    ...
    [Fact]
    public void Array_of_GaussDBRange_of_LocalDate_is_properly_mapped()
        => Assert.Equal("datemultirange", GetMapping(typeof(GaussDBRange<LocalDate>[])).StoreType);

    [Fact]
    public void List_of_GaussDBRange_of_LocalDate_is_properly_mapped()
        => Assert.Equal("datemultirange", GetMapping(typeof(List<GaussDBRange<LocalDate>>)).StoreType);
